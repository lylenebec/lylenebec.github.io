...
<head>
    ...
    <title>Lyle Nebec's Journal</title>
    <style>
        body {
            margin: 0;
            padding: 0;
            ...
            position: relative; /* Ensure that absolute positioning is relative to the body */
        }
        ...
        .shape-2 {
            ...
            z-index: 2; /* shape-2 поверх shape-1 */
        }
